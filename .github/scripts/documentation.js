 ...
 * 2. Runs helm-docs to generate or update documentation for all charts
 * 3. Stages all changes to detect which documentation files were modified
 * 4. Creates a signed commit with these changes to the pull request branch
 * 
