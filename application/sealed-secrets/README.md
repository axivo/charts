...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)  ![Version: 1.0.2](https://img.shields.io/badge/Version-1.0.2-informational?style=flat-square)  ![AppVersion: 2.17.2](https://img.shields.io/badge/AppVersion-2.17.2-informational?style=flat-square)
...
```shell
$ helm install sealed-secrets oci://ghcr.io/axivo/application/sealed-secrets:1.0.2 -n kube-system
```
