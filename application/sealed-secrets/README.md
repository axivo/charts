...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)  ![Version: 1.0.8](https://img.shields.io/badge/Version-1.0.8-informational?style=flat-square)  ![AppVersion: 2.18.6](https://img.shields.io/badge/AppVersion-2.18.6-informational?style=flat-square)

ArgoCD application for the `sealed-secrets` [chart](https://github.com/bitnami-labs/sealed-secrets/blob/helm-v2.18.6/helm/sealed-secrets), deployed into AXIVO [K3s Cluster](https://github.com/axivo/k3s-cluster). Review the cluster [documentation](https://axivo.com/k3s-cluster/), for additional details. The application deployment is also compatible with a generic Kubernetes cluster.
...
|------------|------|---------|
| https://bitnami-labs.github.io/sealed-secrets | sealed-secrets | 2.18.6 |
